<script lang="ts">
	import { BookOpen, GraduationCap, ListChecks } from '@lucide/svelte';
...
<section class="hero">
	...
	<p class="lead">
		Practice questions with instant feedback, or sit a timed mock exam that mirrors the real
		{data.certification.examQuestionCount}-question, {data.certification.examDurationMinutes}-minute
		format.
	</p>
</section>
